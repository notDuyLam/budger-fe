...
Thiết kế 4 màn hình chính (không có màn Account riêng biệt), sử dụng Bottom Navigation Bar trên Mobile và Sidebar trên PC. Thông tin tài khoản người dùng hiển thị trong Dropdown/Popover trên Header.
...
- **Tạo mới:** Tại màn hình Lịch sử giao dịch (History Tab), nút "+ Add Transaction" mở Modal Form chứa các trường:
  ...
  - `Category` (Danh mục phân loại - Bắt buộc với INCOME/EXPENSE)
